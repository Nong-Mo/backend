...
# AWS Voice Chat 자격 증명
AWS_VOICE_CHAT_ACCESS_KEY = os.getenv("AWS_VOICE_CHAT_ACCESS_KEY")
AWS_VOICE_CHAT_SECRET_ACCESS_KEY = os.getenv("AWS_VOICE_CHAT_SECRET_ACCESS_KEY")
